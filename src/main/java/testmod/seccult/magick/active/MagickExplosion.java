...
public class MagickExplosion extends Explosion
{
    ...
    public MagickExplosion(World worldIn, Entity entityIn, double x, double y, double z, float size, List<BlockPos> affectedPositions)
    {
        this(worldIn, entityIn, x, y, z, size, false, true, affectedPositions);
    }

    @SideOnly(Side.CLIENT)
    public MagickExplosion(World worldIn, Entity entityIn, double x, double y, double z, float size, boolean causesFire, boolean damagesTerrain, List<BlockPos> affectedPositions)
    {
        this(worldIn, entityIn, x, y, z, size, causesFire, damagesTerrain);
        this.affectedBlockPositions.addAll(affectedPositions);
    }

    public MagickExplosion(World worldIn, Entity entityIn, double x, double y, double z, float size, boolean flaming, boolean damagesTerrain)
    {
    ...
    public void doExplosionB(boolean spawnParticles)
    {
        ...
        {
        	Particle me = new LightFX(this.world, this.x, this.y, this.z, 1.0D, 0.0D, 0.0D);
        	me.setRBGColorF(255, 0, 0);
        ...
        if (this.damagesTerrain)
        {
            for (BlockPos blockpos : this.affectedBlockPositions)
            {
                ...
                if (spawnParticles)
                {
                    ...
                    d4 = d4 * d7;
                    d5 = d5 * d7;
                	Particle me = new LightFX(this.world, (d0 + this.x) / 2.0D, (d1 + this.y) / 2.0D, (d2 + this.z) / 2.0D, d3, d4, d5);
                	me.setRBGColorF(255, 20, 20);
                	Particle smoke = new LightFX(this.world, d0, d1, d2, d3, d4, d5);
