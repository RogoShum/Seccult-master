...
public class ModEntity  
{
	public static void registerEntities()
	{
		...
		registerEntity("butterfly", EntityButterfly.class, id++, 128, 1, true, 14461039, 16776960);
		registerEntity("dragonfly", EntityDragonfly.class, id++, 128, 1, true, 12654645, 000000);
		registerEntity("bird", EntityBird.class, id++, 128, 1, true, 14461039, 13223074);
		registerEntity("worm", EntityWorm.class, id++, 128, 1, true, 12654645, 12654645);
		registerEntity("fish", EntityFish.class, id++, 128, 1, true, 13223074, 14461039);
		registerEntity("jellyfish", EntityJellyfish.class, id++, 128, 1, true, 13421812, 9526516);
		...
		registerEntityWithoutEgg("lightingthing", EntityLightingThing.class, id++, 128, 1, true);
		...
		registerEntityWithoutEgg("spirit_container", EntitySpiritContainer.class, id++, 128, 1, true);
		registerEntityWithoutEgg("spirit_dummy", EntitySpiritDummy.class, id++, 128, 1, true);
		registerEntityWithoutEgg("king_crimson", EntityKingCrimson.class, id++, 128, 1, true);
	}
