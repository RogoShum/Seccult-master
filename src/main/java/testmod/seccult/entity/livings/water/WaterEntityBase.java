...
public class WaterEntityBase extends EntityWaterMob implements EntityUsingMagicHelper{
	protected float swing;
	protected boolean swingUp;	
	
	private static final DataParameter<Byte> Day = EntityDataManager.<Byte>createKey(WaterEntityBase.class, DataSerializers.BYTE);
	private static final DataParameter<Byte> Sleep = EntityDataManager.<Byte>createKey(WaterEntityBase.class, DataSerializers.BYTE);
	...
	public WaterEntityBase(World worldIn) {
		super(worldIn);
	}
