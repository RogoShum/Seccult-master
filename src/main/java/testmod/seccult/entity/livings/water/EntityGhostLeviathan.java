...
public class EntityGhostLeviathan extends EntityWaterCreature{
	private EntityLivingBase target; 
	private List<DamageReduce> damageList = new ArrayList<DamageReduce>();
	private int swimingTime;
	private int warningTime;
	
	public EntityGhostLeviathan(World worldIn) {
		super(worldIn);		
		this.setSize(4F, 4);
		this.swimingTime += 35;
		this.swingLimit = 15;
	...
	private void warningOthers()
	{
		...
		{
			if(e instanceof EntityGhostLeviathan)
			{
				EntityGhostLeviathan fish = (EntityGhostLeviathan) e;
	...
	private void searchingTarget() {
		...
		{
			Entity e = list.get(i);
			if(e instanceof EntityLivingBase && !(e instanceof EntityGhostLeviathan)  && !(e instanceof EntityVillager) && this.canSeeTarget(e))
			{
				boolean creat = false;
