...
public class EntityWaterTentacle extends EntityWaterCreature implements IMob{
	private List<DamageReduce> damageList = new ArrayList<DamageReduce>();
	private int swimingTime;
	private int warningTime;
	
	public EntityWaterTentacle(World worldIn) {
		super(worldIn);		
		this.setSize(4F, 4);
		this.swimingTime += 35;
		this.swingLimit = 15;
	...
	private void warningOthers()
	{
		...
		{
			if(e instanceof EntityWaterTentacle)
			{
				EntityWaterTentacle fish = (EntityWaterTentacle) e;
