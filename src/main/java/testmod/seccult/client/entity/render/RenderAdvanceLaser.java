...
public class RenderAdvanceLaser extends Render<EntityAdvanceLaser>
{
    ...
    float green;
    float blue;
	public RenderAdvanceLaser(RenderManager renderManager) {
		super(renderManager);
	}
	
	@Override
	public void doRender(EntityAdvanceLaser entity, double x, double y, double z, float yaw, float partialTicks) {
		...
		DrawChannel(x, y, z, entity.getMyWidth(), entity.getMyLength(), yaw, entity.rotationPitch);
	}
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityAdvanceLaser entity) {
		return null;
	}
}
