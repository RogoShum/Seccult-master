...
public class ItemTerrariaEventThing_C extends ItemBase{

	public ItemTerrariaEventThing_C(String name) {
		super(name);
	...
	private void spawnEOW(EntityPlayer player) {
		double x = player.posX + 70;
		double y = player.posY + 70;
		double z = player.posZ + 70;
		
		Entity entity = null;
		 entity = EntityList.createEntityByIDFromName(EOCres, player.getEntityWorld());
	        EntityEoC EOW = (EntityEoC) entity;
            entity.setLocationAndAngles(x, y, z, -player.rotationYaw, -player.rotationPitch);
