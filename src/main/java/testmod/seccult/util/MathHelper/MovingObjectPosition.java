...
public class MovingObjectPosition
{
    ...
    public MovingObjectPosition(int p_i2303_1_, int p_i2303_2_, int p_i2303_3_, int p_i2303_4_, Vec3d p_i2303_5_)
    {
        this(p_i2303_1_, p_i2303_2_, p_i2303_3_, p_i2303_4_, p_i2303_5_, true);
    }

    public MovingObjectPosition(int p_i45481_1_, int p_i45481_2_, int p_i45481_3_, int p_i45481_4_, Vec3d p_i45481_5_, boolean p_i45481_6_)
    {
        ...
        this.hitVec = Vec3d.createVectorHelper(p_i45481_5_.xCoord, p_i45481_5_.yCoord, p_i45481_5_.zCoord);
    }

    public MovingObjectPosition(Entity p_i2304_1_)
    {
        this(p_i2304_1_, Vec3d.createVectorHelper(p_i2304_1_.posX, p_i2304_1_.posY, p_i2304_1_.posZ));
    }

    public MovingObjectPosition(Particle p_i2304_1_)
    {
        this(p_i2304_1_, Vec3d.createVectorHelper(particleHelper.getPosX(p_i2304_1_), particleHelper.getPosY(p_i2304_1_), particleHelper.getPosZ(p_i2304_1_)));
    }
    
    public MovingObjectPosition(Entity p_i45482_1_, Vec3d p_i45482_2_)
    {
    ...
    public MovingObjectPosition(Particle p_i45482_1_, Vec3d p_i45482_2_)
    {
        this.typeOfHit = MovingObjectPosition.MovingObjectType.ENTITY;
        this.particleHit = p_i45482_1_;
        this.hitVec = p_i45482_2_;
    }
