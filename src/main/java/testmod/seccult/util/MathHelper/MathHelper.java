...
public class MathHelper
{
	...
	public static Vec3d onLookVec(Entity e, double distance, double height) {
		Vec3d look = e.getLookVec();
		Vec3d pos = e.getPositionVector().addVector(0, height, 0);
		return pos.addVector(look.x * distance, look.y * distance, look.z * distance);
	}
    
	public static Vec3d onLookVec(Vec3d vec, double x, double y, double z, double distance, double height) {
		Vec3d pos = new Vec3d(x,y,z).addVector(0, height, 0);
		return pos.addVector(vec.x * distance, vec.y * distance, vec.z * distance);
	}
