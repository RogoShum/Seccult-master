package testmod.seccult.world.gen.generators;
...
public class WorldGenEverythingTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = ModBlocks.LOGS.getDefaultState().withProperty(Log.VARIANT, TreeHandler.EnumType.EVERYTHING);
	public static final IBlockState LEAF = ModBlocks.LEAVES.getDefaultState().withProperty(Leaf.VARIANT, TreeHandler.EnumType.EVERYTHING);
	
	private final int minHeight;
	
	public WorldGenEverythingTree() 
	{
		super(false);
		this.minHeight = 12;
	}
	...
	public boolean generate(World world, Random rand, BlockPos pos) 
	{
		...
		else
		{
			...
			boolean isSoil = state.getBlock().canSustainPlant(state, world, down, EnumFacing.UP, (Sapling)ModBlocks.SAPLINGS);
