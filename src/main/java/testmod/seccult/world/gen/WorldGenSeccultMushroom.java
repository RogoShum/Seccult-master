...
public class WorldGenSeccultMushroom extends WorldGenerator{
	   /** The mushroom type. 0 for brown, 1 for red. */
    private final Block mushroomType;

    public WorldGenSeccultMushroom(Block p_i46449_1_)
    {
        super(true);
        this.mushroomType = p_i46449_1_;
    }

    public WorldGenSeccultMushroom()
    {
        super(false);
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (block == null)
        {
            block = rand.nextBoolean() ? ModBlocks.Mush : ModBlocks.RedMush;
        }
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 < 256)
        {
            ...
            else
            {
                ...
                if (block1 != Blocks.DIRT && block1 != Blocks.GRASS && block1 != ModBlocks.Hypha)
                {
                    return false;
                }
                else
                {
                    ...
                    if (block == ModBlocks.RedMush)
                    {
                        k2 = position.getY() + i - 4;
                    }
                    ...
                    for (int l2 = k2; l2 <= position.getY() + i; ++l2)
                    {
                        ...
                        for (int l1 = k3; l1 <= l3; ++l1)
                        {
                            for (int i2 = j1; i2 <= k1; ++i2)
                            {
                                ...
                                if (block == ModBlocks.Mush || l2 < position.getY() + i)
                                {
