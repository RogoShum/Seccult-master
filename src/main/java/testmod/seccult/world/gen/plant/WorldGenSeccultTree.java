...
public class WorldGenSeccultTree extends WorldGenAbstractTree{
    private Random rand;
    private World world;
    ...
    List<WorldGenSeccultTree.FoliageCoordinates> foliageCoords;
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<WorldGenSeccultTree.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new WorldGenSeccultTree.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new WorldGenSeccultTree.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeaves()
    {
        for (WorldGenSeccultTree.FoliageCoordinates BlueTree$foliagecoordinates : this.foliageCoords)
        {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if(!loaded || !loaded1 || !loaded2 || !loaded3)
        return false;
